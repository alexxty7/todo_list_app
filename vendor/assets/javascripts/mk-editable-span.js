...
mod.directive('editablespan', function() {
  return {
    restrict: 'E',
    template: '<div class="editable-span"><span ng-hide="editing" ng-class="spanClass">{{text}}</span><form ng-show="editing"><input type="{{getInputType()}}" ng-class="inputClass"></form><div>',
    scope: {
      text: '=model',
      onReady: '&',
      spanClass: '@',
